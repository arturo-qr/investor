<html>
	...
	<title>News: Investing Ideas & Strategies</title>
	<body>
		...
		<div id="PageContainerOuter">
			<div id="PageContainer">
				<div class="innerclear">
					...
					<h1>Investing Ideas & Strategies</h1>
					</br></br>

					<?php
				    $i=0;
				    $url = "http://news.google.com/?ned=us&topic=t&output=rss"; // url of google news
				    $xml = simplexml_load_file('http://finance.yahoo.com/news/category-ideas-and-strategies/rss'); //loading the document
